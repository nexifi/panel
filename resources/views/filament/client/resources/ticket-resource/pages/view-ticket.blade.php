        ...
        <div class="bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900 rounded-3xl p-10 border border-slate-700/50 shadow-2xl">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 mb-10">
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        <h1 class="text-4xl lg:text-5xl font-bold text-white mb-3 leading-tight">{{ $this->getViewData()['ticket']->subject }}</h1>
                        <p class="text-slate-300 text-xl">Ticket #{{ $this->getViewData()['ticket']->id }}</p>
                    </div>
                </div>
                ...
                <div class="bg-slate-800/60 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 hover:bg-slate-800/80 transition-all duration-300">
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p class="text-white font-bold text-xl">{{ \Carbon\Carbon::parse($this->getViewData()['ticket']->created_at)->format('d/m/Y H:i') }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-slate-800/60 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 hover:bg-slate-800/80 transition-all duration-300">
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            <p class="text-slate-300 text-sm uppercase font-semibold tracking-wide">Mis à jour</p>
                            <p class="text-white font-bold text-xl">{{ \Carbon\Carbon::parse($this->getViewData()['ticket']->updated_at)->format('d/m/Y H:i') }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-slate-800/60 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 hover:bg-slate-800/80 transition-all duration-300">
