    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-500 mt-1">Ticket #{{ $this->getViewData()['ticket']->id }}</p>
                </div>
                <div class="flex gap-2">
                    <span class="px-3 py-1 text-sm font-medium rounded-full {{ match($this->getViewData()['ticket']->status) {
                    ...
                    <span class="px-3 py-1 text-sm font-medium rounded-full {{ match($this->getViewData()['ticket']->priority) {
            ...
            <div class="mt-4 grid grid-cols-3 gap-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                <div>
                    ...
                    <p class="font-medium">{{ \Carbon\Carbon::parse($this->getViewData()['ticket']->created_at)->format('d/m/Y H:i') }}</p>
                </div>
                <div>
                    <p class="text-sm text-gray-500">Mis à jour</p>
                    <p class="font-medium">{{ \Carbon\Carbon::parse($this->getViewData()['ticket']->updated_at)->format('d/m/Y H:i') }}</p>
                </div>
                <div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="flex items-start gap-4">
                    <div class="w-10 h-10 {{ $response->is_staff_response ? 'bg-green-500' : 'bg-blue-500' }} rounded-full flex items-center justify-center text-white font-bold">
