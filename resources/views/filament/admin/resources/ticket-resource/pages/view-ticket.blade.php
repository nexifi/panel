        ...
        <div class="bg-white/95 backdrop-blur-sm border border-white/20 rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Ticket #{{ $this->record->id }}</p>
                </div>
                <div class="flex gap-2">
                    <span class="px-3 py-1 text-sm font-medium rounded-lg backdrop-blur-sm {{ match($this->record->status) {
                    ...
                    <span class="px-3 py-1 text-sm font-medium rounded-lg backdrop-blur-sm {{ match($this->record->priority) {
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 pt-6 border-t border-gray-200/50">
                <div class="text-center md:text-left p-4 bg-gray-50/80 backdrop-blur-sm border border-gray-100/50 rounded-lg">
                    ...
                    <p class="font-semibold text-gray-900">{{ \Carbon\Carbon::parse($this->record->created_at)->format('d/m/Y H:i') }}</p>
                </div>
                <div class="text-center md:text-left p-4 bg-gray-50/80 backdrop-blur-sm border border-gray-100/50 rounded-lg">
                    <p class="text-sm text-gray-600 mb-1">Mis à jour</p>
                    <p class="font-semibold text-gray-900">{{ \Carbon\Carbon::parse($this->record->updated_at)->format('d/m/Y H:i') }}</p>
                </div>
                <div class="text-center md:text-left p-4 bg-gray-50/80 backdrop-blur-sm border border-gray-100/50 rounded-lg">
