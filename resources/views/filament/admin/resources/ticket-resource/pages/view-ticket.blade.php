        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-2">
                    <span class="px-3 py-1 text-sm font-medium rounded-lg {{ match($this->record->status) {
                    ...
                    <span class="px-3 py-1 text-sm font-medium rounded-lg {{ match($this->record->priority) {
